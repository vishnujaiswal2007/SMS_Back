...
class userController {
  ...
  static getDiscipline = async (req, res) => {
    ...
    for (const stu of students) {
      ...
      if (stu.MajorDiscipline1 && stu.descipline1MajorPracticalMax !== "")
      ...
      if (stu.MajorDiscipline2 && stu.descipline2MajorPracticalMax !== "")
          ...
          recordsToInsert.push({
            ...
            Result: {
              ...
              ...(disciplineMajor1Details?.DISCIPLINE && {
                ...
                ...(disciplineMajor1Details?.MajorPracticalMax != null && {
                  MajorDiscipline1PracticalMax:
                    disciplineMajor1Details.MajorPracticalMax,
                  MajorDiscipline1PracticalObtained: "",
                }),

                ...(disciplineMajor1Details?.MajorPracticalCreditMax !=
                  null && {
              ...
              ...(disciplineMajor2?.DISCIPLINE && {
                ...
                ...(disciplineMajor2Details?.MajorPracticalMax != null && {
                  MajorDiscipline2PracticalMax:
                    disciplineMajor2Details?.MajorPracticalMax,
                  MajorDiscipline2PracticalObtained: "",
                }),
                ...(disciplineMajor2Details?.MajorPracticalCreditMax !=
                  null && {
              ...
              ...(disciplineMajor3?.DISCIPLINE && {
                ...
                ...(disciplineMajor3Details?.MajorPracticalMax != null && {
                  MajorDiscipline3PracticalMax:
                    disciplineMajor3Details?.MajorPracticalMax,
                  MajorDiscipline3PracticalObtained: "",
                }),
                ...(disciplineMajor3Details?.MajorPracticalCreditMax !=
                  null && {
                  MajorDiscipline3PracticalCreditMax:
                    disciplineMajor3Details?.MajorPracticalCreditMax,
                  MajorDiscipline3PracticalCreditObtained: "",
                }),
    ...
    try {
      ...
      if (!(myobj?.sem?.PRG_CODE === "PRE008")) {
        ...
        for (const s of students) {
          ...
          const minorHasPractical = safeInt(s.MinorDisciplinePracticalMax) > 0;

          const minorPractical = safeInt(s.MinorDisciplinePracticalObtained);

          const minorPracticalAbsent =
            minorHasPractical && s.MinorDisciplinePracticalObtained === "AA";
          ...
          // ======================
          if (
            isAnyAbsent([s.MinorDisciplinePaperObtained]) ||
          ...
          // ======================
            ...
            minorHasPractical &&
            !isPass(minorPractical, s.MinorDisciplinePracticalMax)
          ) {
            minorPass = false;
            minorPerc = 0;
          ...
          const minorTheoryAbsent = isAnyAbsent([
            s.MinorDisciplinePaperObtained,
          ]);
      ...
      // ======================================================================================================
      // BCOM RESULT CALCULATION START FROM HERE
      // =======================================================================================================
      else {
        // ======================
        // HELPER FUNCTIONS
  ...
  static getdetailsNep = async (req, res) => {
    ...
    if (data) {
      ...
      res.status(400).send({
        status: "Fail",
        message: "Credentials are mismatch",
      });
    }
  };
  ...
  static ModifyNepMarks = async (req, res) => {
    ...
    // console.log("Grade Value", gradingSystem)
    const query = {
      Session: myobj.Session,
